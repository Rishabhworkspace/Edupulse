    ...
    <div className="min-h-[80vh] flex items-center justify-center py-12" style={{ background: 'var(--color-bg)' }}>
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="w-full max-w-md px-6">
        <div className="text-center mb-8">
          ...
          <h1 className="font-display text-2xl font-bold mb-2" style={{ color: 'var(--color-text-primary)' }}>Welcome back</h1>
          <p className="text-sm" style={{ color: 'var(--color-text-body)' }}>Sign in to continue your learning journey</p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <div className="flex items-center justify-between mb-1.5">
                <label className="text-xs font-semibold" style={{ fontFamily: "'DM Sans', sans-serif", color: 'var(--color-text-body)' }}>Password</label>
                <Link to="/forgot-password" className="text-xs font-medium no-underline" style={{ color: 'var(--color-coral)' }}>Forgot?</Link>
              </div>
              <div className="relative">
        ...
        <p className="text-center text-sm mt-6" style={{ color: 'var(--color-text-body)' }}>
          Don't have an account? <Link to="/register" className="font-semibold no-underline" style={{ color: 'var(--color-coral)' }}>Create one</Link>
        </p>
      </motion.div>
    </div>
  );
