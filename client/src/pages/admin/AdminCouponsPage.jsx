      ...
      {showCreate && (
        <div className="card p-6 mb-6">
          ...
          <form onSubmit={handleCreate} className="grid md:grid-cols-3 gap-4">
            ...
            <div><label className="text-xs font-semibold mb-1 block" style={{ color: 'var(--text-secondary)' }}>Type</label><select className="input" value={form.type} onChange={(e) => setForm({ ...form, type: e.target.value })}><option value="percentage">Percentage</option><option value="flat">Flat</option></select></div>
